...
st.markdown(f'<header style="background-color:white;color:#00008b;font-size:24px;border-radius:2%;">   AI App For Chatting With Files</header>', unsafe_allow_html=True)
